...
TextStyle captionStyle = const TextStyle(color: kwhite, fontSize: 20,fontWeight: FontWeight.bold);
TextStyle headStyle=const TextStyle(color: kwhite,fontSize: 15,fontWeight: FontWeight.bold);
TextStyle dateStyle= TextStyle(color: kwhite.withOpacity(0.7),fontSize: 10);
...
Application refers to LinkHub, the software program provided by the Company.          
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to LinkHub.          
...
By email: ameenahaneef11@gmail.com
...
var textabout = RichText(
  text: TextSpan(
    ...
    children: [
      ...
      const TextSpan(
        text: 'Welcome to LinkHub, a cutting-edge social media platform designed to bring you closer to your friends, family, and interests. Our app is packed with features that make sharing and connecting easier and more enjoyable than ever.\n\n',
      ),
      TextSpan(
        text: 'Features:\n-----------\n',
        style: headStyle
      ...
      const TextSpan(
        text: '''
Create and Share Posts: Capture and share photos and videos with your followers.\n
Likes and Comments: Engage with posts by liking and commenting, fostering a vibrant community interaction.\n
Real-Time Chat: Stay connected with friends through private messages sharing texts, seamlessly.\n
Personalized Profiles: Customize your profile with a bio, profile picture, and details to express your personality.\n
Privacy and Security: Control your privacy settings and manage who can see your posts, ensuring a secure social media experience.

Join LinkHub today to start sharing your moments, engaging with friends, and discovering new content.

For support or inquiries, contact us at ameenahaneef11@gmail.
''',
      ),
    ],
  ),
